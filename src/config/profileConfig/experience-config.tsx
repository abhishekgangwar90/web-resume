  ...
  experienceData: [
    {
      ...
      extendedDetails: [
        {
          id: 1,
          description: `Worked as an individual UI contributor and developed Data insights platform from scratch, Primary responsibilities were writing testable and performance oriented code which can be scalable easily.`,
        },
        {
          id: 2,
          description:
            'Single-handedly spearheaded migration of data insights UI from Sisense, which saved $65000/year of Subscription money and increased project revenue by 85%.',
        },
        {
          id: 3,
          description:
